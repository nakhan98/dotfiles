" Space.vim -- Vim colorscheme.
" Maintainer: nakhan98 (github.com/nakhan98)
" Version: 0.1
" A colorscheme loosely modeled after the spacegray theme for Xcode.
" This colorscheme is 256color and up only.
"
" Based on SpaceGray by Akshay Hegde (github.com/ajh17)
...
hi Visual          ctermbg=236  ctermfg=NONE   guibg=#5D5D5D  guifg=NONE     cterm=NONE      gui=NONE
